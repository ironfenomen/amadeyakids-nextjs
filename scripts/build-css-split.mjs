...
const critical = [
  ...
  banner("kids: навигация — меню закрыто до JS (anti-FOUC, канон детокса)") +
    "header a{text-decoration:none;color:inherit}header .nav>div{display:none}.header-menu{display:none}.over-content .header-menu{display:block}.menu-wrapper ul,.menu-items{list-style:none;margin:0;padding:0}@media only screen and (min-width:1024px){header .nav{display:block;height:auto}header .nav>div{display:block}.header-menu{display:block}.header-menu ul{display:flex;margin:0;padding:0;list-style:none}.menu-wrapper ul.level-1>li{display:block}.menu-wrapper ul.level-1>li>a{display:block;font-size:14px;font-weight:500;padding:0 10px;line-height:54px}.menu-wrapper ul.level-2{display:none}.menu-wrapper li.level-1:hover ul.level-2{position:absolute;z-index:4500;display:block;margin:0}}",
  banner("kids: шапка — каркас до догрузки бандла (anti-FOUC: без рассыпания/бликов)") +
    ".header-items{display:flex;align-items:center;justify-content:space-between}.header-item-slogan,.header-item-social,.header-item-button{display:none}.header-item-phones span{display:none}.header-item-phones{line-height:1}",
